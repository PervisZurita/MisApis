...
export const getAllEjemplos = async (req, res) => {
    ...
    try {
      ...
      return res.status(500).json({
        msg: 'Hubo un error al obtener los ejemplos, inténtelo de nuevo más tarde.'
      });
    }
  };
...
export const getEjemploById = async (req, res) => {
    ...
    try {
      ...
      return res.status(500).json({ msg: 'Error al obtener el ejemplo' });
    }
  };
  ...
  export const putEjemplo = async (req, res) => {
    ...
    try {
      ...
      return res.status(500).json({ msg: 'Error al actualizar el ejemplo' });
    }
  };
  export const deleteEjemplo = async (req, res) => {
    ...
    try {
      ...
      return res.status(200).json({msg:'Ejemplo eliminado',ejemplo})
    } catch (error) {
      return res.status(500).json({ msg: 'Error al eliminar el ejemplo' });
    }
  };